...
data.forEach(company => {
    ...
    nameCell.textContent = company.company_name || company.Company_name; // Handle different key casing
    row.appendChild(nameCell);
    
    const imgCell = document.createElement('td');
    const img = document.createElement('img');
    img.src = company.img_src;
    img.alt = company.company_name || company.Company_name;
    imgCell.appendChild(img);
    row.appendChild(imgCell);
    
    const aboutCell = document.createElement('td');
    aboutCell.textContent = company.about;
